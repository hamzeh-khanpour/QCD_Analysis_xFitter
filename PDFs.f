...
!  
! --    Compile with:
! --    gfortran KSASG20_nPDFs.f -L /usr/local/lib -lLHAPDF
! ---------------------------------------
  ...
  !-- Test three PDF sets that have different uncertainty calculations.      
        ...
        call InitPDFSetByNameM(nset,"MSTW2008nnlo68cl")  !!! For the central value
